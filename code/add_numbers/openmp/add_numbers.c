...
float dynamic_add_numbers(int n_numbers, float *numbers) {
  printf("Adding %i numbers ...\n", n_numbers);
...
float guided_add_numbers(int n_numbers, float *numbers) {
  printf("Adding %i numbers ...\n", n_numbers);
...
float auto_add_numbers(int n_numbers, float *numbers) {
  printf("Adding %i numbers ...\n", n_numbers);
